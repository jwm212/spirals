...
for i in arr:
    ...
    clip1.ClipType.Origin = [0.10000000149011612, 0.0, 0.14169]
    ...
    clip2.ClipType.Origin = [0.282, 0.0, 0.023499999195337296]
    ...
    clip3.ClipType.Origin = [-0.105, 0.0, 0.023499999195337296]
    ...
    glyph1.ScaleFactor = 0.0168/velocity[i]
