...
for i in arr:
    ...
    clip1.ClipType.Origin = [0.10000000149011612, 0.0, 0.070845]
    ...
    clip2.ClipType.Origin = [0.141, 0.0, 0.023499999195337296]
    ...
    clip3.ClipType.Origin = [-0.0525, 0.0, 0.023499999195337296]
    ...
    glyph1.ScaleFactor = 0.0084/velocity[i]
